...
func (i *initAuthority) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []sysModel.SysAuthority{
		...
		{AuthorityId: 9527, AuthorityName: "游客", ParentId: utils.Pointer[uint](0), DefaultRouter: "dashboard"},
		{AuthorityId: 1, AuthorityName: "测试人员", ParentId: utils.Pointer[uint](0), DefaultRouter: "dashboard"},
		{AuthorityId: 2, AuthorityName: "开发人员", ParentId: utils.Pointer[uint](0), DefaultRouter: "dashboard"},
	}
